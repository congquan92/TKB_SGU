    ...
    return (
        <div className="space-y-3 bg-card">
            <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                {rows.length > 0 && (
                    <div className="flex items-center gap-1 border border-border p-0.5 bg-muted/40">
                        <Button
                            type="button"
            ...
            <div className={viewMode === "table" ? "block" : "hidden"}>
                ...
                <p className="sm:hidden text-[10px] text-muted-foreground font-mono mb-2">← Vuốt ngang để xem đủ →</p>

                <div className="overflow-x-auto border-2 border-border bg-card scrollbar-hide">
                    <table className="w-full min-w-[700px] text-sm cursor-pointer">
